...
summary(glm(soil_moisture ~ simpsons, data = soil_density %>% filter(date == "2022-05-06")))
summary(glm(soil_moisture ~ simpsons, data = soil_density %>% filter(date == "2022-06-09")))
summary(glm(soil_moisture ~ simpsons, data = soil_density %>% filter(date == "2022-07-15")))
summary(glm(soil_moisture ~ simpsons, data = soil_density %>% filter(date == "2022-09-08")))
summary(glm(soil_moisture ~ simpsons, data = soil_density %>% filter(date == "2022-10-19")))
summary(glm(soil_moisture ~ simpsons, data = soil_density %>% filter(date == "2022-11-21")))
...
summary(glm(par ~ simpsons, data = par_density %>% filter(date == "2022-05-06")))
summary(glm(par ~ simpsons, data = par_density %>% filter(date == "2022-06-09")))
summary(glm(par ~ simpsons, data = par_density %>% filter(date == "2022-07-15")))
summary(glm(par ~ simpsons, data = par_density %>% filter(date == "2022-09-08")))
summary(glm(par ~ simpsons, data = par_density %>% filter(date == "2022-10-19")))
summary(glm(par ~ simpsons, data = par_density %>% filter(date == "2022-11-21")))
```
...
summary(lm(simpsons ~ soil_moisture, data = soil_transplant))
