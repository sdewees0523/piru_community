...
natural_recruitment_ibutton <- natural_recruitment %>% 
  left_join(max_temperature, by = "plot") %>% 
  left_join(max_vpd, by = "plot")

summary(glm(present~temperature, family = "binomial", data = natural_recruitment_ibutton))
summary(glm(present~vpd, family = "binomial", data = natural_recruitment_ibutton))
