...
```{r}
files_1 <- list.files(here("data", "ibutton_data", "july", "temperature"), pattern = ".csv")
files_2 <- list.files(here("data", "ibutton_data", "july", "temperature", "skip_18"), pattern = ".csv" )
files_3 <- list.files(here("data", "ibutton_data", "september", "temp"), pattern = ".csv")
files_4 <- list.files(here("data", "ibutton_data", "september", "temp", "skip_18"), pattern = ".csv" )

ibutton_temp_1 <- read_csv(here("data", "ibutton_data", "july", "temperature", files_1), skip = 14, id = "plot") %>% 
...
ibutton_temp_2 <- read_csv(here("data", "ibutton_data", "july", "temperature", "skip_18", files_2), skip = 18, id = "plot") %>% 
  rename(date = "Date/Time",
         time = Unit) %>% 
  separate(Value, into = c("unit", "temperature"), sep = ",") %>% 
...
ibutton_temp_3 <- read_csv(here("data", "ibutton_data", "september", "temp", files_3), skip = 14, id = "plot") %>% 
  rename(date = "Date/Time",
         time = Unit) %>% 
  separate(Value, into = c("unit", "temperature"), sep = ",") %>% 
  ...
  mutate(temperature = as.numeric(temperature),
         temperature = (temperature * (9/5)) + 32)
ibutton_temp_4 <- read_csv(here("data", "ibutton_data", "september", "temp", "skip_18", files_4), skip = 18, id = "plot") %>% 
  rename(date = "Date/Time",
         time = Unit) %>% 
  separate(Value, into = c("unit", "temperature"), sep = ",") %>% 
...
ibutton_temp <- rbind(ibutton_temp_1, ibutton_temp_2, ibutton_temp_3, ibutton_temp_4) %>%
  distinct() %>% 
